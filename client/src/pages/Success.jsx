    ...
    <div className="content-wrapper flex items-center justify-center py-20">
       <section className="w-auto h-auto bg-light-gray flex flex-col items-center justify-center gap-4" >
        <Canvas/>
          ...
          <h1 className='text-Primary text-4xl font-clash font-medium text-center'>Thank You for Purchasing </h1>
          ...
          <button className='bg-Primary text-white font-satoshi font-normal px-6 py-3' onClick={goToProducts}>Continue Shopping</button>
       </section>
    </div>
    </>
  )
