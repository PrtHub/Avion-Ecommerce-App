  ...
  return (
    <>
      <footer className="w-full h-full bg-Primary">
        <div className="w-full xl:w-[1260px] h-full mx-auto flex flex-col items-start justify-center gap-10 px-7 xl:px-0 py-5">
          ...
          <section className="w-full h-full flex items-center justify-center md:justify-between flex-wrap border-t-2 border-t-[#4E4D93] py-5 ">
          <h1 className="text-white text-sm font-satoshi font-normal">Copyright&copy;2023 Avion LTD</h1>
